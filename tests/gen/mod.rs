...
pub mod cake {
	...
	pub enum Relation {
		...
		#[sea_orm(has_many = "super::cakes_bakers::Entity")]
		CakesBakers,
		#[sea_orm(has_many = "super::lineitme::Entity")]
		Lineitme,
	}
	...
	impl Related<super::lineitme::Entity> for Entity {
		fn to() -> RelationDef {
			Relation::Lineitme.def()
		}
	}
...
pub mod lineitme {
	...
	#[derive(Clone, Debug, PartialEq, DeriveEntityModel)]
	#[sea_orm(table_name = "lineitme", schema_name = "public")]
	pub struct Model {
		#[sea_orm(column_type = "Integer", primary_key)]
		pub id: i32,
		#[sea_orm(column_type = "Decimal(Some((19, 4)))")]
